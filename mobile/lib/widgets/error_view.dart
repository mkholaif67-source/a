...
String efErrorMessage(int status, [dynamic data]) {
  ...
  if (status == 0) {
    return 'تعذر الوصول للخدمة. راجع الاتصال وحاول مرة أخرى؛ بياناتك المحفوظة لم تحذف.';
  }
  if (status == 408) return 'استغرق الاتصال وقتا أطول من المعتاد. حاول مرة أخرى؛ لا تحتاج لإدخال بياناتك من جديد.';
  ...
  if (status >= 500) {
    return 'تعذر التحميل حاول مرة أخرى';
  }
  if (status == 404) {
