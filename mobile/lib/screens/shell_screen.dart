...
class _ShellScreenState extends State<ShellScreen> with WidgetsBindingObserver {
  ...
  // ── شريط تنقل عائم (2026) — حبة منزلقة خلف الأيقونة النشطة. ──
  // نفس التبويبات الأربعة ونفس _go بالظبط؛ التغيير بصري/تفاعلي فقط.
  Widget _buildNavBar() {
    const items = <(IconData, IconData, String)>[
      (Icons.home_outlined, Icons.home_rounded, 'الرئيسية'),
      (Icons.fitness_center_outlined, Icons.fitness_center_rounded, 'تمرين'),
      (Icons.restaurant_outlined, Icons.restaurant_rounded, 'تغذية'),
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(EFR.sheet),
          ...
          child: Stack(
            children: [
              // الحبة المنزلقة خلف التبويب النشط (RTL-aware عبر AlignmentDirectional).
              AnimatedAlign(
                duration: EFM.med,
                curve: EFM.curve,
                alignment: AlignmentDirectional(-0.75 + _i * 0.5, 0),
                child: FractionallySizedBox(
                  ...
                  child: Center(
                    child: Container(
                      ...
                      height: 44,
                      decoration: BoxDecoration(
                        color: AppColors.nu.withValues(alpha: .15),
              ...
              Row(
                children: [
                  for (var i = 0; i < items.length; i++)
                    _navItem(i, items[i].$1, items[i].$2, items[i].$3),
                ],
              ),
            ],
          ),
  ...
  Widget _navItem(int index, IconData icon, IconData activeIcon, String label) {
    final sel = _i == index;
    final color = sel ? AppColors.nu : AppColors.muted;
    return Expanded(
      child: GestureDetector(
        ...
        child: Column(
          ...
          children: [
            Icon(sel ? activeIcon : icon, color: color, size: 24),
